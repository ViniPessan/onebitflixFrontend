      ...
      <main>
        ...
        <Container className="d-flex flex-column align-items-center gap-3 pt-5">
          ...
          <p className="text-center py-4">
            ...
            inventore consequatur labore minima totam cupiditate ab tempora.
            Atque, recusandae, distinctio voluptas itaque fugit impedit aperiam
            iusto earum temporibus veniam, excepturi veritatis neque. Porro odio
            nemo, molestiae quis nesciunt velit sint iusto unde eos voluptatibus,
            quo tempora expedita atque, architecto alias!
          </p>
        </Container>
